...
(module+ test
  ...
  (define (test-initial-dependencies)
    (let ((expected-test-assignment-dependencies
           (list
      ...
      (init-tests)
      (check-equal?
       ((AssignmentHandler-get-dependencies
         (Assignment-assignment-handler test-assignment))
        test-assignment)
       expected-test-assignment-dependencies)))
